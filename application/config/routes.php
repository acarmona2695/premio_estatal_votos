...
$route['ajax/cargarFormularioInicio'] = 'InicioController/loadFormulario'; //listNominadosForModalidadForUser
// $route['ajax/listNominadosForModalidadForUser'] = 'InicioController/listNominadosForModalidadForUser';
