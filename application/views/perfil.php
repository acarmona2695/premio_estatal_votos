...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Descripción','Comentarios'],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'descripcion',index:'descripcion',width:'100px',resizable:false,sortable:true,align:'center',title:false},
  {name:'comentarios',index:'comentarios',width:'100px',resizable:false,sortable:true,align:'center',title:false},
  ],
  width: null,
  shrinkToFit: false,
  loadtext: 'Cargando...',
...
function cargarForm(id){
  $.ajax({
    type: "POST",
    dataType: "json",
    url: "ajax/cargarFormularioPerfil",
    data:{csrf_directorio_token:$('#token').val(),pk_perfil: id},
    beforeSend: function(){
