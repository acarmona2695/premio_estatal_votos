...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Nombre del Entrenador','Asociación','Disciplina'],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'nombre_entrenador',index:'nombre_entrenador',width:'230px',resizable:false,sortable:true,align:'center',title:false},
  ...
  viewrecords: true,
  caption: 'Listado de Entrenadores',
  multiselect: false
...
function cargarForm(id){
  $.ajax({
    ...
    data:{csrf_directorio_token:$('#token').val(),pk_entrenador: id},
    beforeSend: function(){
