...
<main class="col-md-12 ms-sm-auto col-lg-12 px-md-12">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Deportista o Atleta</h1>
  </div>
  <div>
...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Nombre del Deportista','Asociación','Disciplina'],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'nombre_atleta',index:'nombre_atleta',width:'230px',resizable:false,sortable:true,align:'center',title:false},
  {name:'fk_asociacion',index:'fk_asociacion',width:'230px',resizable:false,sortable:true,align:'center',title:false},
  {name:'fk_disciplina',index:'fk_disciplina',width:'230px',resizable:false,sortable:true,align:'center',title:false},
  ...
  viewrecords: true,
  caption: 'Listado de Deportistas o Atletas',
  multiselect: false
...
function cargarForm(id){
  $.ajax({
    type: "POST",
    dataType: "json",
    url: "ajax/cargarFormularioAtleta",
    data:{csrf_directorio_token:$('#token').val(),pk_atleta: id},
    beforeSend: function(){
