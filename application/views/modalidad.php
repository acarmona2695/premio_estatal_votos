...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Nombre Modalidad'],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'nombre_modalidad',index:'nombre_modalidad',width:'150px',resizable:false,sortable:true,align:'center',title:false},
  ],
  width: null,
  shrinkToFit: false,
  loadtext: 'Cargando...',
