...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Descripción', "Estatus"],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'descripcion',index:'descripcion',width:'150px',resizable:false,sortable:true,align:'center',title:false},
  {name:'estatus',index:'estatus',width:'150px',resizable:false,sortable:true,align:'center',title:false},
  ],
  width: null,
  shrinkToFit: false,
  loadtext: 'Cargando...',
  ...
  viewrecords: true,
  caption: 'Listado de modalidades',
  multiselect: false
...
function cargarForm(id){
  $.ajax({
    type: "POST",
    dataType: "json",
    url: "ajax/cargarFormularioModalidad",
    data:{csrf_directorio_token:$('#token').val(),pk_modalidad: id},
    beforeSend: function(){
