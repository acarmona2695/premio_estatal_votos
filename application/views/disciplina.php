...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Nombre Disciplina'],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'nombre_disciplina',index:'nombre_disciplina',width:'150px',resizable:false,sortable:true,align:'center',title:false},
  ],
  width: null,
  shrinkToFit: false,
  loadtext: 'Cargando...',
...
function cargarForm(id){
  $.ajax({
    type: "POST",
    dataType: "json",
    url: "ajax/cargarFormularioDisciplina",
    data:{csrf_directorio_token:$('#token').val(),pk_disciplina: id},
    beforeSend: function(){
