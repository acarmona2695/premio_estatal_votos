...
$("#grid").jqGrid({
  ...
  colNames:['Editar','Nombre','Asociación','Disciplina'],
  colModel:[
  {name:'btnEditar',index:'btnEditar',width:'90px',resizable:false,sortable:false,align:'center',title:false},
  {name:'nombre',index:'nombre',width:'230px',resizable:false,sortable:true,align:'center',title:false},
...
function cargarForm(id){
  $.ajax({
    ...
    data:{csrf_directorio_token:$('#token').val(),pk_fomento: id},
    beforeSend: function(){
