<form id="form">
  <input type="text" class="form-control" name="pk_atleta" value="<?=$pk_atleta?>" id="pk_atleta" hidden>
  <div class="row">
  <div class="col-md-12">
      <label for="nombre_atleta" class="col-form-label">Nombre Completo del Deportista:</label>
      <input type="text" class="form-control" name="nombre_atleta" id="nombre_atleta" value="<?=$INFO['nombre_atleta']?>" autocomplete="off" required>
    </div>
